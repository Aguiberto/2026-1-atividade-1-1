...
Esta atividade tem como objetivo aprender a criar um docker para aplicação web usando o Django FRAMEWORK

## RELATO DAS ATIVIDADES

A atividade consiste primeiramente em configurar e criar um container docker, em seguida configurar e criar a aplicação Django , tudo isso executando comandos no terminal e modificando os documentos conforme orientado pelo tutorial fornecido pelo professor
